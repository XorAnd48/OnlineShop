...
public class MenuKategori extends Menu {
    ...
    public void tampilMenu() {
        ...
        do {
            ...
            System.out.println("+=============================================+");
            System.out.println("| 1 | Tampil Daftar Kategori                  |");
            System.out.println("+---+-----------------------------------------+");
            System.out.println("| 2 | Tambah Daftar Kategori                  |");
            System.out.println("+---+-----------------------------------------+");
            System.out.println("| 3 | Edit Daftar Kategori                    |");
            System.out.println("+---+-----------------------------------------+");
            System.out.println("| 4 | Hapus  Daftar Kategori                  |");
            System.out.println("+---+-----------------------------------------+");
