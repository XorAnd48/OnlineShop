...
import onlineshop.controller.Kategori;
...
public class MenuProduk extends Menu {
    ...
    public MenuProduk(ArrayList<Produk> data, DataOnlineShop dataOnlineShop) {
        this.data = data;
        this.dataOnlineShop = dataOnlineShop;
    }
    ...
    public void tampilMenu() {
        ...
        do {
            ...
            System.out.println("+=============================================+");
            System.out.println("| 1 | Tampil Daftar Produk                    |");
            System.out.println("+---+-----------------------------------------+");
            System.out.println("| 2 | Tambah Daftar Produk                    |");
            System.out.println("+---+-----------------------------------------+");
            System.out.println("| 3 | Edit Daftar Produk                      |");
            System.out.println("+---+-----------------------------------------+");
            System.out.println("| 4 | Hapus Daftar Produk                     |");
            System.out.println("+---+-----------------------------------------+");
    ...
    public void tampilData() {
        ...
        if (data.size() > 0) {
            ...
            for (Produk tempProduk : data) {
                ...
                String namaKategori = dataOnlineShop.getNamaKategori(tempProduk.getKategori());
        ...
        ScreenHelper.clearConsole();
        ArrayList<Kategori> dataKategori = dataOnlineShop.initKategori();
